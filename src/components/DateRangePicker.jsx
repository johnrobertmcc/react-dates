...
class DateRangePicker extends React.PureComponent {
  constructor(props) {
    ...
    this.onDateRangePickerInputFocus =
      this.onDateRangePickerInputFocus.bind(this);
    ...
    this.showKeyboardShortcutsPanel =
      this.showKeyboardShortcutsPanel.bind(this);

    this.responsivizePickerPosition =
      this.responsivizePickerPosition.bind(this);
  ...
  onOutsideClick(event) {
    const { onFocusChange, onClose, startDate, endDate, appendToBody } =
      this.props;
